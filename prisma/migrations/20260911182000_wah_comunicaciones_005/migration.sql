-- WAH Comunicaciones — Datos 005_comunicaciones_wah.sql (cima literal clone)
...
CREATE UNIQUE INDEX "whatsapp_accounts_empresa_phone_key"
  ON "whatsapp_accounts"("empresa_id", "phone_number_id");
CREATE INDEX "ix_whatsapp_accounts_empresa_active"
  ON "whatsapp_accounts"("empresa_id", "active");
CREATE UNIQUE INDEX "whatsapp_accounts_user_id_uidx"
...
ALTER TABLE "whatsapp_accounts" ADD CONSTRAINT "whatsapp_accounts_user_id_fkey"
...
CREATE UNIQUE INDEX "wah_conversations_account_contact_key"
  ON "wah_conversations"("account_id", "wa_contact_id");
CREATE INDEX "ix_wah_conversations_empresa_last_message"
  ON "wah_conversations"("empresa_id", "last_message_at" DESC);
CREATE INDEX "ix_wah_conversations_empresa_pending"
  ON "wah_conversations"("empresa_id", "pending_human");
CREATE INDEX "ix_wah_conversations_empresa_unread"
...
CREATE TABLE "wah_messages" (
    ...
    CONSTRAINT "wah_messages_direction_check" CHECK ("direction" IN ('inbound', 'outbound'))
);

CREATE INDEX "ix_wah_messages_conversation_created"
  ON "wah_messages"("conversation_id", "created_at" ASC);
CREATE INDEX "ix_wah_messages_empresa_created"
  ON "wah_messages"("empresa_id", "created_at" DESC);
CREATE UNIQUE INDEX "uq_wah_messages_wamid"
...
ALTER TABLE "wah_messages" ADD CONSTRAINT "wah_messages_sender_user_id_fkey"
...
CREATE INDEX "ix_wah_media_empresa_created"
  ON "wah_media"("empresa_id", "created_at" DESC);
CREATE INDEX "wah_media_message_idx"
  ON "wah_media"("message_id");
CREATE UNIQUE INDEX "uq_wah_media_meta_media_id"
  ON "wah_media"("meta_media_id") WHERE "meta_media_id" IS NOT NULL;

ALTER TABLE "wah_media" ADD CONSTRAINT "wah_media_empresa_id_fkey"
  FOREIGN KEY ("empresa_id") REFERENCES "empresa"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "wah_media" ADD CONSTRAINT "wah_media_message_id_fkey"
